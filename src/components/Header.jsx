...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-blue-950 text-white backdrop-blur-md shadow-md">
      ...
      {/* Mobile nav links */}
      {isOpen && (
        <div className="md:hidden px-6 pb-4 space-y-2 bg-blue-950 bg-opacity-90">
          <a
            href="#about"
