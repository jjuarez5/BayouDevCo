...
const ContactForm = () => (
  <section
    id="contact"
    className="twinkling-bg py-24 px-4 sm:px-6 text-white border-t border-gray-200"
  >
    <motion.div
      initial={{ opacity: 0, scale: 0.95 }}
      whileInView={{ opacity: 1, scale: 1 }}
      transition={{ duration: 0.5 }}
      className="max-w-xl mx-auto bg-slate-700 bg-opacity-70 backdrop-blur-md p-10 rounded-2xl shadow-xl border border-white/10"
    >
